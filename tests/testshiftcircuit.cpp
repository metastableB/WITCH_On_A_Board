...
TestShiftCircuit::TestShiftCircuit () {
	...
	if(!accum.getStringStateInStore().compare("9876543219999999"))
		std::cout << "Accumulator transfer/shift TEST 2.01 SUCCESSFUL \n";
	else {
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.01 shift() FAILURE "
	...
	if(!accum.getStringStateInStore().compare("9765432199999999"))
		std::cout << "Accumulator transfer/shift TEST 2.02 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.02 shift() FAILURE "
	...
	if(!accum.getStringStateInStore().compare("8654321088888888"))
		std::cout << "Accumulator transfer/shift TEST 2.03 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.03 shift() FAILURE "
	...
	if(!accum.getStringStateInStore().compare("7939990068888888"))
		std::cout << "Accumulator transfer/shift TEST 2.04 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.04 shift() FAILURE "
	...
	if(!accum.getStringStateInStore().compare("7940057709668888"))
		std::cout << "Accumulator transfer/shift TEST 2.05 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.05 shift() FAILURE "
	...
	if(!accum.getStringStateInStore().compare("8027712029668888"))
		std::cout << "Accumulator transfer/shift TEST 2.06 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.06 shift() FAILURE "
	...
	if(!accum.getStringStateInStore().compare("0211111109000000"))
		std::cout << "Accumulator transfer/shift TEST 2.07 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.07 shift() FAILURE "
	...
	if(!accum.getStringStateInStore().compare("9211211108999999"))
		std::cout << "Accumulator transfer/shift TEST 2.08 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.08 shift() FAILURE "
	...
	transferUnit.transfer(&source,&accum,7);
	if(!accum.getStringStateInStore().compare("9999999999999999"))
		std::cout << "Accumulator transfer/shift TEST 2.09 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.09 shift() FAILURE "
		<< getHumanReadableOutput(accum.getStringStateInStore(),16) << " vs 9 9999 9999 9999 999\n";
	}
	...
	if(!accum.getStringStateInStore().compare("0987698753779100"))
		std::cout << "Accumulator transfer/shift TEST 2.10 SUCCESSFUL \n";
	else{
		failedTests++;
		std::cout << "Accumulator transfer/shift TEST 2.10 shift() FAILURE "
